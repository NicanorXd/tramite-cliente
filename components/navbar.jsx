...
const Navbar = () => {
  // screen context
  const { mode, toggle, setToggle, fullscreen, setFullscreen } =
  ...
  // entity context
  const { entity_id, setEntityId, render, disabled } =
  ...
  const handleRefreshPage = async (e) => {
    ...
    let answer = await Confirm(
      `warning`,
      "¿Estás seguro en actualizar la página?",
      "Actualizar"
    );
      ...
      <header className={`app-header app-header-dark bg-default`}>
        <div className="top-bar">
          <div
            ...
            style={{
              display:
                fullscreen || !extendView.includes(mode) ? "none" : "flex",
            }}
          >
            <a href="/">
              <Logo />
          ...
          <div className="top-bar-list">
            ...
            <div className="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
              <ul className="header-nav nav">
                <Show condicion={extendView.includes(mode)}>
                  <li className="nav-item">
                    <a href="" className="nav-link" onClick={handleRefreshPage}>
              ...
              <div className="dropdown d-flex">
                <Show
                  condicion={!auth_context.loading}
                  ...
                  >
                    <span className="user-avatar user-avatar-md">
                      <img
                        src={
                          (auth_context.auth &&
                            auth_context.auth.image_images &&
                            auth_context.auth.image_images.image_50x50) ||
                ...
                <div className="dropdown-menu">
                  ...
                  <Link href="/docs">
                    <a className="dropdown-item">
                      <span className="fas fa-info-circle"></span> Ayuda
                    </a>
                  </Link>
                  <a
                    href="#logout"
                  ...
                  >
                    <span className="fas fa-sign"></span> Cerrar Cuenta
                  </a>
                </div>
              </div>
            </div>
